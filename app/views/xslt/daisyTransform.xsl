    ...
    <html>
        ...
        <xsl:for-each select="//dtb:img">
            ...
            <script type="text/javascript">
                <xsl:attribute name="src">http://localhost:3000/imageDesc.json?uid=<xsl:value-of select="/dtb:dtbook/dtb:head/dtb:meta[@name='dtb:uid']/@content"/>&amp;image_location=<xsl:value-of select="@src"/>&amp;callback=<xsl:value-of select="$divId"/>Callback</xsl:attribute>
            </script>
        </xsl:for-each>
    </html>
  </xsl:template>
  ...
  ************************ *** -->
  ...
  <xsl:template match="dtb:img">
    ...
    <xsl:element name="form">
        ...
        <xsl:attribute name="action">http://localhost:3000/imageDesc</xsl:attribute>
